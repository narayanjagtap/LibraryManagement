...
<body>
<h1 style="font-size:50px;">Renewal Book</h1>
	...
	<h2 style="text-align: center; font-size: 30px">Issued Book Details</h2>
		...
		<c:forEach var="bookdetails" items="${issuedBooksList}">
			      <tr>
					...
					<td><a href="./renewalBook?bookId=${bookdetails.bookId }&studentId=${bookdetails.stdId }&returnDate=${bookdetails.returnDate }">
							<input type="button" name="" value="renewal" class="editButton"></a></td>
				</tr>
		</c:forEach>
	</table>
</c:if>
