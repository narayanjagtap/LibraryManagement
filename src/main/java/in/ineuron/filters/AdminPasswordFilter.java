...
@WebFilter(urlPatterns = "/adminChangePassword")
public class AdminPasswordFilter extends HttpFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		System.out.println("Admin Password filter:: " + req.getRequestURI());
		...
		if (req.getRequestURI().endsWith("adminChangePassword")) {
			password = request.getParameter("adminPassword");
			cnfPassword = request.getParameter("adminConfirmPassword");
			...
			if (password == null && cnfPassword == null) {
				...
				targetFile = "./changeAdminPassword.jsp";
